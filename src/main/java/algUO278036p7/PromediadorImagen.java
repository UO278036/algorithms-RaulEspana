...
public class PromediadorImagen extends BranchAndBound {
	...
	*/
	...
	public void splitSubsetsBacktracking(int max_unbalancing) {
		counter = 1;
		max_zncc = 0;
		recursivoBactrackingPoda(3, max_unbalancing, 0, 0, 0);
	}
	...
	public void branchAndBoundMethod() {
		super.counterBnB = 0;
		branchAndBound(new NodeAvg(dataset, new ArrayList<Integer>(), 0));
        this.half1_img = ((NodeAvg)bestNode).getHalf1_avg();
        this.half2_img = ((NodeAvg)bestNode).getHalf2_avg();
